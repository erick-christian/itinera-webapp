/*
 * File: app/store/storeTaxiFares.js
 *
...
Ext.define('catTaxiFares.store.storeTaxiFares', {
    extend: 'Ext.data.Store',

    requires: [
        'catTaxiFares.model.modTaxiFares',
        'Ext.data.proxy.Rest',
    ...
    constructor: function (cfg) {
        ...
        me.callParent([Ext.apply({
            storeId: 'storeTaxiFares',
            model: 'catTaxiFares.model.modTaxiFares',
            proxy: {
                type: 'rest',
                url: '',
                reader: {
