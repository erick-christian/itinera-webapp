describe("Ext.Array", function () {
    ...
    describe("every", function () {
        ...
        it("should return true on an empty array", function () {
            expect(Ext.Array.every([], function () {
            })).toBeTruthy();
        });
    ...
    describe("some", function () {
        ...
        it("should return false on an empty array", function () {
            expect(Ext.Array.some([], function () {
            })).toBeFalsy();
        });
    ...
    describe("min", function () {
        describe("numbers", function () {
            ...
            it("with comparisonFn", function () {
                expect(Ext.Array.min([1, 2, 3, 4, 5, 6], function (a, b) {
                    return a < b ? 1 : -1;
                })).toEqual(6);
            });
        });
    ...
    describe("max", function () {
        describe("numbers", function () {
            ...
            it("with comparisonFn", function () {
                expect(Ext.Array.max([1, 2, 3, 4, 5, 6], function (a, b) {
                    return a < b ? 1 : -1;
                })).toEqual(1);
            });
        });
