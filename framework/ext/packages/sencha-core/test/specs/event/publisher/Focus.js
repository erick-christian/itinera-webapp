describe("Ext.event.publisher.Focus", function () {
    ...
    describe("focusenter", function () {
        describe("fires", function () {
            ...
            createSuite("from the document", function () {
                body.focus();
            });
            createSuite("from its parent", function () {
                a[1].focus();
            });
            createSuite("from a parent's sibling", function () {
                a[3].focus();
            });
            createSuite("from a sibling el", function () {
                b[2].focus();
            });
        });
